...
class RankTypeInsertGQLModel:
    name: str = strawberry.field(description="name of the rank type")
...
class RankTypeUpdateGQLModel:
    ...
    name: typing.Optional[str] = strawberry.field(description="name of the rank type", default=None)
    name_en: typing.Optional[str] = strawberry.field(description="english name of the rank type", default=None)
