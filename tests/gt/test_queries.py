...
test_medal_create = createTest2(tableName="medals", queryName="create", variables={"name": "newname"})
test_medal_delete = createDeleteTest2(tableName="medals", variables={"id": "18375c23-767c-4c1e-adb6-9b2beb463533", "name": "newname"})
...
test_medal_type_create = createTest2(tableName="medaltypes", queryName="create", variables={"name": "newname"})
test_medal_type_update = createUpdateTest2(tableName="medaltypes", variables={"name": "newname"})
test_medal_type_delete = createDeleteTest2(tableName="medaltypes", variables={"name": "newname"})
